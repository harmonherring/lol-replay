...
<footer class="footer">
	<div class="container">
		<div class="content">
			<p>
			<strong>LoL Replay</strong> by <a href="https://github.com/1lann" target="_blank">1lann</a>. The <a href="https://github.com/harmonherring/lol-replay" target="_blank">source code</a> is licensed under the <a href="https://github.com/harmonherring/lol-replay/pkgblob/master/LICENSE" target="_blank">MIT license</a>.
			</p>
			<p>
